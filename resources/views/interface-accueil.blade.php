...
@section('content')
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><strong class="text-danger2">{{ array_sum($location_per_commune_zogbodomey) }}</strong>
                        </td>
                    </tr>
                </tbody>
            </table>
    ...
    <div class="row mt-4">
        <div class="col">
            <h6>Répartition par <strong class="text-danger2">Sexe</strong></h6>
            <canvas id="sexChartAllCommunes" width="400" height="400"></canvas>
        </div>
        <div class="col">
            <h6>Répartition par <strong class="text-danger2">Sexe</strong> (Bassila)</h6>
            <canvas id="sexChartBassila" width="400" height="400"></canvas>
        </div>
        <div class="col">
            <h6>Répartition par <strong class="text-danger2">Sexe</strong> (Zogbodomey)</h6>
    ...
    <div class="row mt-4">
        <div class="col">
            <h6>Tableau de répartition des moustiques par <strong class="text-danger2">Sexe</strong> par commune</h6>
            <table class="table table-striped">
                <thead>
                    <tr>
                        <th>Sexe</th>
                ...
                <tbody>
                    ...
                    <tr>
                        <td><strong class="text-danger2">Total</strong></td>
                        <td><strong class="text-danger2">{{ array_sum($sex_per_commune_bassila) }}</strong></td>
                        <td><strong class="text-danger2">{{ array_sum($sex_per_commune_zogbodomey) }}</strong></td>
                    </tr>
                </tbody>
            </table>
        </div>
