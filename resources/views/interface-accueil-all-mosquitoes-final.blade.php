            ...
            <table class="table table-striped ">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><strong class="text-danger2">{{ $total_species_bassila }} ({{ $total_records <> 0 ? round($total_species_bassila * 100/$total_records,2):"N/A" }}%)</strong></td>
                        <td><strong class="text-danger2">{{ $total_species_zogbodomey }} ({{ $total_records <> 0 ? round($total_species_zogbodomey * 100/$total_records,2):"N/A" }}%)</strong></td>
                    </tr>
                </tbody>
            </table>
        </div>
